...
function NotFoundComponent() {
  return (
    <div translate="no" className="notranslate flex min-h-screen items-center justify-center bg-background px-4">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    scripts: [
      {
        async: true,
        src: "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1651524817871346",
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en" translate="no" className="notranslate">
      <head>
        <HeadContent />
        <meta name="google-site-verification" content="c6VsNjDxGenY1Rzufk2VDS5t9xUOF-h2L9FhJf2ac" />
<meta name="google-site-verification" content="dV2khQDVvOt5a7oks1FWBosSZ_w3tLfdCP4fwF-WVmU" />
